...
class IntroViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        titleLogo.image = UIImage(named: "BCC1")!
        
       UIView.transition(with: titleLogo, duration: 1.0, options: [.transitionFlipFromLeft], animations: nil, completion: nil)
...
//        // UIImage インスタンスの生成
//        let image1:UIImage = UIImage(named:"BCC1")!
//
//        // UIImageView 初期化
